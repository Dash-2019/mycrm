...
import { Company, Contact, Deal, MeiSai } from '../types';
                ...
                <Card>
                    <CardContent>
                        ...
                        >
                            ...
                            <TabbedShowLayout.Tab label="ノート">            
                                <ReferenceManyField
                                    target="company_id"
            ...
            {contacts.map(contact => (
                <RecordContextProvider key={contact.id} value={contact}>
                    ...
                    >
                        ...
                        <ListItemText
                            primary={`${contact.last_name} ${contact.first_name}`}
                            secondary={
                                <>
                                    {contact.役職}
                                    {contact.nb_tasks
...
const BranchIterator = () => {
    const { data: branches, error, isPending } = useListContext<MeiSai>();
    const { dealStages } = useConfigurationContext();
    if (isPending || error) return null;
                ...
                {branches.map(branch => (
                    ...
                    >
                        ...
                        <ListItemSecondaryAction>
                            ...
                            >
                                last activity{' '}
                                {formatDistance(branch.created_at, now)} ago{' '}
                            </Typography>
                        </ListItemSecondaryAction>
                    </ListItem>
                ))}
