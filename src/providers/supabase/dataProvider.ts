...
const dataProviderWithCustomMethods = {
    ...
    async getList(resource: string, params: GetListParams) {
        ...
        //     return baseDataProvider.getList('comments', params);
        // }
        if (resource === 'com') {
            return baseDataProvider.getList('com_view', params);
        }
    ...
    async getOne(resource: string, params: any) {
        ...
        // if (resource === 'comments') {
        //     return baseDataProvider.getOne('comments', params);
        // }
        if (resource === 'com') {
            return baseDataProvider.getOne('com_vew', params);
        }
...
export const dataProvider = withLifecycleCallbacks(
    ...
    [
        ...
        },
        {
            ...
            beforeGetList: async params => {
                console.log("---contacts_summary------------11---")
